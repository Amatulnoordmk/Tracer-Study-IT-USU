					...
					<div class="signup-form">
						...
						<form action="<?= base_url('register/aksidaftar') ?>" method="POST"
							...
							<div class="form-group">
								...
								<input class="form-control" type="nim" name="nim" id="nim" placeholder="nim"
									onkeyup="cekNim()" />
							...
							<div class="signup-image">
								...
								<a href="<?= base_url('login') ?>" class="signup-image-link">Sudah punya akun ? silakan
									login!</a> <br>
	...
	<script type="text/javascript">
		...
		function cekNim() {
			...
			if (nim == "") {
				...
				$('#pesan_nim').html("Nim tidak boleh lebih dari 9 digit.");
				$('#pesan_nim').css('color', 'red');
				nim_error = 1;
			} else {
				$.ajax({
